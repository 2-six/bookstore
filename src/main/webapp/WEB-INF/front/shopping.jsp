            ...
            <form action="shopping-result.html">
                    ...
                    <c:forEach var="good" items="${sessionScope.cart.goods}">
                        <tr id="product_id_1">
                            <td class="thumb"><img height="80" width="80"
                                                   src="${pageContext.request.contextPath}/images/product/${good.key.image}"/><a
                            ...
                            <td class="price">
                                <span>￥</span>
                                <span id="goodSum${good.key.pirce*good.value}">${good.key.pirce*good.value}</span>
                            </td>
                ...
                <div class="button">
                    ...
                    <c:if test="${sessionScope.user!=null}"><a id="submit" href="#"><img
                            src="/bookstore/images/pay.png"></a></c:if>
...
<script src="/bookstore/js/shopping.js"></script>
</body>
</html>