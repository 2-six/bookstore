...
<div id="main" class="wrap">
	...
	<div id="product" class="main">
		...
		<h3> </h3>
		<div class="infos">
			<div class="thumb"><img height="300" width="300" src="${pageContext.request.contextPath}/images/product/${book.image}" /></div>
			<div class="buy">
				...
				<p>库　存：${book.store}</p>
				<p>购买数量：
					<span id="sub" onclick="subNum();"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></span>&nbsp;
					<input style="height: 25px; width:25px;" id="number" name="number" value="1" size="2" readonly/>&nbsp;
					<span id="add" onclick="addNum();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></span>
				</p>
				<div class="button">
				<c:if test="${book.store>0}">
					<a id="buy" href="#"><img class="buyBtn" src="${pageContext.request.contextPath}/images/buy.jpg"></a>&nbsp;&nbsp;&nbsp;
					<input type="hidden" id="bid" value="${book.bid}"  />&nbsp;&nbsp;&nbsp;
					<a id="submit" href="#"><img src="${pageContext.request.contextPath}/images/cart.png"></a>
				</c:if>
				<c:if test="${book.store==0}">
			...
			<div class="pager">
					<ul class="clearfix">
						...
						<c:forEach var="index" begin="1" end="${pageInfo.pages }">
							...
							<a href="bookView.do?pageNum=${index }&bid=${book.bid}">${index }</a></li>
						</c:forEach>
