...
<head>
	...
	<script src="/bookstore/js/order.js"></script>
</head>
<body>
		...
		<form action="shopping-result.html">
			<table>
				<tr>
					...
					<tr id="product_id_1">
					<td class="thumb"><img height="80" width="80" src="${pageContext.request.contextPath}/images/product/${good.key.image}" /><a href="bookView.do?bid=${good.key.bid}">${good.key.bname}</a></td>
					<td class="price" >
			...
			<div class="button">
				...
				<a id="submit" href="#">
					<img src="/bookstore/images/orderSub.png">
				</a>
			</div>
		</form>
		</c:if>
